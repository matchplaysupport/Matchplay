...
const ITEMS = [
  ...
  {
    q: "What's the scoring side about?",
    a: "Every round you book can be played in-app: match-play and stroke-play scoring, automatic handicap tracking, and live leaderboards with your regular group. It's the reason golfers keep the app on their home screen between bookings.",
  },
  {
    q: "When can I actually use it?",
    a: "We're onboarding courses and golfers region by region right now. Join the waitlist and we'll reach out the moment we're live near you — early members get priority access.",
  },
];
