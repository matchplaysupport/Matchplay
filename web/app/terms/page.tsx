...
export const metadata: Metadata = {
  ...
  description: "The terms that govern your use of Match Play.",
  ...
  return (
    <LegalPage title="Terms of Service" updated="June 28, 2026">
      <Section heading="Acceptance">
        <p>
          By joining the Match Play waitlist or using our websites and apps (the &quot;Services&quot;), you agree to these Terms. If you do
          not agree, please do not use the Services.
        </p>
      </Section>
      <Section heading="The Services">
        <p>
          Match Play connects golfers with tee times offered by independent golf courses and provides scoring, handicap, and leaderboard
          features. Courses set their own availability and pricing; Match Play is not the operator of any course and is not responsible
      ...
      <Section heading="Bookings &amp; payments">
        <p>
          ...
          Payments are processed by Stripe. Course operators receive payouts under the terms of their Match Play agreement.
        </p>
      </Section>
      ...
      <Section heading="Disclaimers &amp; liability">
        <p>
          The Services are provided &quot;as is&quot; without warranties of any kind. To the maximum extent permitted by law, Match Play is not
      ...
      <Section heading="Contact">
        <p>Questions about these Terms? Email <strong>legal@matchplay.golf</strong>.</p>
      </Section>
    </LegalPage>
  );
}
